...
class Command(BaseCommand):
    help = 'Send a reminder for a specific presentation id (or latest)'

    def add_arguments(self, parser):
        parser.add_argument('--id', type=int, dest='presentation_id', help='PresentationRequest id to target')
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Reminder invoked for presentation id {p.id} (minutes_before={minutes})'))
